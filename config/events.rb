...
WebsocketRails::EventMap.describe do
  ...
  subscribe :new_user, to: WebSocketController, with_method: :new_user
  subscribe :change_username, to: WebSocketController, with_method: :change_username
  subscribe :client_disconnected, to: WebSocketController, with_method: :delete_user
end
